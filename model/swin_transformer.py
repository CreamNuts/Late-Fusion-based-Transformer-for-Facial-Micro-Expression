...
from .transformer_utils import DropPath, I3DHead, Mlp, trunc_normal_
...
default_cfgs = {
    "ch1_swin": _cfg(in_chans=1),
    "ch3_swin": _cfg(in_chans=3),
    "ch4_swin": _cfg(in_chans=4),
    "ch6_swin": _cfg(in_chans=6),
}
...
class Swin(nn.Module):
    ...
    def __init__(self, cfg, num_classes=3):
        ...
        self.backbone = SwinTransformer3D(**cfg["backbone"])
        if num_classes > 0:
